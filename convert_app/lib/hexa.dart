...
import 'octa.dart';
import 'main.dart';
void main() => runApp(Myhexa());

class Myhexa extends StatelessWidget {
  @override
...
class MyCustomForm extends StatefulWidget {
  @override
  _MyHexaFormState createState() => _MyHexaFormState();
}

// Define a corresponding State class.
// This class holds data related to the Form.

class _MyHexaFormState extends State<MyCustomForm> {
