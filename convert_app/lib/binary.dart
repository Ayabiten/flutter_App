...
import 'octa.dart';
import 'hexa.dart';
void main() => runApp(MyBina());

class MyBina extends StatelessWidget {
  @override
...
class MyCustomForm extends StatefulWidget {
  @override
  _MyBinaryFormState createState() => _MyBinaryFormState();
}

// Define a corresponding State class.
// This class holds data related to the Form.

class _MyBinaryFormState extends State<MyCustomForm> {
  ...
  void _doSomething(String text) {
    setState(() {
      _Deci = int.parse('$text',radix: 2).toRadixString(10);
      _Octa = int.parse('$text',radix: 2).toRadixString(8);
      _Hexa = int.parse('$text',radix: 2).toRadixString(16);
    });
  }
}